...
http://madhugnadig.com/articles/parallel-processing/2017/02/25/parallel-computing-in-cusing-
openMP.html
*/
...
void selectionSort(int* A, int n) {
	for(int startpos =0; startpos < n; startpos++) {
		...
		// Parallel for loop with custom reduction, at the end of the loop, max will have the max
